...
## Context
The reference architecture needs an explicit, reviewable decision for **lakehouse architecture** so implementation and documentation do not drift.

## Decision
Use a governed lakehouse as the analytical system of record rather than a Hadoop lake plus separate warehouse by default.
